    ...
    <div className="p-6 bg-gradient-to-r from-blue-500 to-green-500 min-h-screen">
      ...
      {add.length === 0 ? (
        ...
        <>
                ...
                <div className="p-4 flex flex-col justify-between w-full">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="bg-green-500 text-white py-2 px-4 rounded hover:bg-green-700 transition w-1/2"
                    >
                      Buy Now
                    </button>
                    <button
                      onClick={() => handleRemove(index)}
                      className="bg-red-500 text-white py-2 px-4 rounded hover:bg-red-700 transition w-1/2"
                    >
                      Remove
                    </button>
                  </div>
          ...
          <div className="mt-10 bg-white p-6 rounded-lg shadow-xl text-center">
